...
export const siteContent: Record<Lang, SiteContent> = {
  pt: {
    layout: {
      title: "Além do Código | Empresa de Tecnologia & IA | FinTech · PropTech · Faro",
      description:
        "Empresa de tecnologia baseada em Faro que constrói produtos próprios de IA para o setor do crédito e imobiliário: CRMCredito.pt, CréditoCasa.pt e SimulaSite.pt.",
    },
    nav: {
      about: "Sobre",
      projects: "Projetos",
  ...
  en: {
    layout: {
      title: "Beyond Code | Technology & AI Company | FinTech · PropTech · Faro",
      description:
        "Technology company based in Faro building its own AI products for credit and real estate: CRMCredito.pt, CréditoCasa.pt and SimulaSite.pt.",
    },
    nav: {
      about: "About",
      projects: "Projects",
